...
//-------------------------------------------------------------------------------
        $mform->addElement('header', '', get_string('limittime','forum'));
        $mform->addElement('checkbox', 'limitforum', get_string('limitforum', 'forum'));
        $mform->addElement('date_time_selector', 'limittime', get_string('limitdate', 'forum'));
        $mform->disabledIf('limittime','limitforum');
//-------------------------------------------------------------------------------
...
// buttons
    ...
    function data_preprocessing(&$default_values){
		...
		if (empty($default_values['limittime']))
          {
          $default_values['limittime'] = 0;
          $default_values['limitforum'] = 0;                 
          }
        else
          {
          $default_values['limitforum'] = 1;
          }
