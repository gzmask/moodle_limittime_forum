...
//===== 1.9.0 upgrade line ======//
  ...
  // Added by Enright  
  // Define field limittime to be added to forum table - required for lockable forums
  if ($result && $oldversion < 2007101513)
    {
    $table = new XMLDBTable('forum');
    $field = new XMLDBField('limittime');
    $field->setAttributes(XMLDB_TYPE_INTEGER, '10', XMLDB_UNSIGNED, XMLDB_NOTNULL, null, null, null, '0', 'blockperiod');
